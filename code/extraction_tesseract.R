...
for (folder in base) {
  ...
  file_extractions  <- mapply(extraction_tesseract, files)
  ...
  write_csv(extraction_text,
            file = file.path(output, paste0("extraction_tesseract_", basename(folder), ".csv")))
  
  message("Export Complete!")
}

# stopped at Converting page 1 to EFTA01421367_1.png... done!